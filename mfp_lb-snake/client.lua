...
CreateThread(function ()
    ...
    local function AddApp()
        local added, errorMessage = exports["lb-phone"]:AddCustomApp({
            ...
            size = Config.size, 
            price = Config.price, 
            images = {"https://r2.fivemanage.com/pub/2rbzvo4py5mz.png", "https://r2.fivemanage.com/pub/di22j5sc97su.png", "https://r2.fivemanage.com/pub/8sbjfr6gc77q.png"}, -- OPTIONAL array of images for the app on the app store
